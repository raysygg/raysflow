...
/**
 * SysModelRouterRule 数据访问 Mapper 接口。
 * 提供基于 MyBatis-Plus 的数据库 CRUD 与自定义 SQL 操作。
 */
@Mapper
/**
 * SysModelRouterRule 数据访问 Mapper 接口。
 * 提供基于 MyBatis-Plus 的 SysModelRouterRule 数据库读写方法。
 */
public interface SysModelRouterRuleMapper extends BaseMapper<SysModelRouterRuleEntity> {
}
